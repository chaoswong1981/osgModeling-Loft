 ...
 */
class NormalVisitor : public vEngine::NodeVisitor
{
public:
    ...
    static void buildNormal( vEngine::Geometry& geoset, bool flip=false, int method=MWE, double threshold=1e-6 );

    virtual void apply( vEngine::Geode& geode );

protected:
    static bool checkPrimitives( vEngine::Geometry& geom );
